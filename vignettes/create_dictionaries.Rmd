...
vignette: >
  %\VignetteIndexEntry{labelmachine}
...
<img src = "../reference/figures/vignette_create_dictionary.png" style = "width: 100%; max-width: 450px">
</img>
...
* [Altering of lama-dictionaries]
* [Get started]

[magrittr]: https://cran.r-project.org/web/packages/magrittr/vignettes/magrittr.html
[Get started]: https://a-maldet.github.io/labelmachine/articles/labelmachine.html
[Creation of lama-dictionaries]: https://a-maldet.github.io/labelmachine/articles/create_dictionaries.html
[Altering of lama-dictionaries]: https://a-maldet.github.io/labelmachine/articles/alter_dictionaries.html
[Translation of variables]: https://a-maldet.github.io/labelmachine/articles/translate.html
...
df <- data.frame(
  ...
  level = factor(rep(c("a", "b", "b", "a"), each = 3), levels = c("a", "b")),
