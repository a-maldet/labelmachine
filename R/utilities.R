...
#' Transform data structure from yaml format to the [lama_dictionary][new_dictionary()] class input format
#'
#' When a yaml file is read in, the data has the structure
#' vars (named list) > translations (named list)
#' This structure is transformed to the [lama_dictionary][new_dictionary()] class input structure
...
#' Transform data structure from [lama_dictionary][new_dictionary()] class input format to the yaml format
#'
#' In the [lama_dictionary][new_dictionary()] class object the data has the structure
#' vars (named list) > translations (named character vector)
