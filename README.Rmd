...
The label assignments are given as so called **translations** (named character vectors),
which are like a recipe, telling which original value will be mapped onto which new label.
The **translations** are collected in a so called **lama_dictionary** object.
...
[get started vignette]:  https://R-package.github.io/labelmachine/index.html
